...
namespace DAO
{
	...
	/// </summary>
	public partial class t_index_announce_DAL
	{
		public t_index_announce_DAL()
		{}
		#region  BasicMethod
		...
		public t_index_announce GetModel(int iAutoID)
		{
			...
			t_index_announce model=new t_index_announce();
		...
		/// 得到一个对象实体
		/// </summary>
		public t_index_announce DataRowToModel(DataRow row)
		{
			t_index_announce model=new t_index_announce();
			if (row != null)
			{
