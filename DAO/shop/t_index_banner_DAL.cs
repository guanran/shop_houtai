...
namespace DAO
{
	...
	/// </summary>
	public partial class t_index_banner_DAL
	{


        public t_index_banner_DAL()
		{}
		#region  BasicMethod
		...
		public t_index_banner GetModel(int iAutoID)
		{
			...
			t_index_banner model=new t_index_banner();
		...
		/// 得到一个对象实体
		/// </summary>
		public t_index_banner DataRowToModel(DataRow row)
		{
			t_index_banner model=new t_index_banner();
			if (row != null)
			{
