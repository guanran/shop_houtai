...
namespace DAO
{
	...
	/// </summary>
	public partial class t_unit_goods_list_DAL
    {
		public t_unit_goods_list_DAL()
		{}
		#region  BasicMethod
		...
		public t_unit_goods_list GetModel(int id)
		{
			...
			t_unit_goods_list model=new t_unit_goods_list();
		...
		/// 得到一个对象实体
		/// </summary>
		public t_unit_goods_list DataRowToModel(DataRow row)
		{
			t_unit_goods_list model=new t_unit_goods_list();
			if (row != null)
			{
