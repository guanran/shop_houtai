    ...
    */
    ...
    var tabs = $.widget("ui.tabs", {
        ...
        _toggle: function (event, eventData) {
            ...
            function show() {
                eventData.newTab.closest("li").addClass("current");
...
inputbox.prototype = {
    ...
    initialize: function (opt) {
        ...
        switch(opt.width){
            case 'long': this.MAINCLASS = "Text_long"; break;
            case 'middle': this.MAINCLASS = "Text_middle"; break;
            case 'short': this.MAINCLASS = "Text_short"; break;
            default: this.MAINCLASS = "Text_middle"; break;
        }
    ...
    renderTextbox:function(){
        ...
        this.item.className = this.MAINCLASS;
        ...
        this.input.onfocus = function () {
            this.parentNode.className = classname + '_focus';
            //if (this.value != "") {
            //    this.select();
            //}
        }
...
DropDownList.prototype = {
    ...
    RenderCSS_5: function (e, ColumnCount, ShowSide, Width) {
        ...
        e.style.border = "1px solid #1bacab";
    },
...
function FixTableNew(TableID, FixColumnNumber, width, className) {
    ...
    if ($("#" + TableID + "_tableLayout").length != 0) {
        ...
        $("#" + TableID).after("<div id='" + TableID + "_tableLayout' class='" + className + "' style='width:100%;'></div>");
    }
...
//        $("#allcheck").children("label").removeClass("checked");
//    }
//    else {
//        $(this).children("label").addClass("checked");
//        if ($(".mytable").width() > 880) {
//            if ($(".list-checkbox .checked").length == ($(".list-checkbox label").length - 1) / 2) {
//                $("#allcheck").children("label").addClass("checked");
//            }
//        } else {
//            if ($(".list-checkbox .checked").length == $(".list-checkbox label").length - 1) {
//                $("#allcheck").children("label").addClass("checked");
//            }
//        }
...
//    if ($(this).children("label").hasClass("checked")) {
//        $("div[groupname='checkgroup']").children("label").removeClass("checked").addClass("checked");
//    } else {
//        $("div[groupname='checkgroup']").children("label").removeClass("checked");
//    }
//});
